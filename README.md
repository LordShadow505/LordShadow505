...
> **Aspiring Game Developer & Semi-Professional Artist**  

## About Me

I'm a developer in training with a strong focus on **Python** and **Godot** – my primary tools for rapid prototyping, game logic, and automation. As an artist, I create assets and visual designs to complement my development projects.

## Tech Stack

###  **Primary Technologies**
- **Python** – My main language for scripting, automation, and tools
- **Godot** – Game engine 
- **C / C++ / C#** – Systems programming and engine integration
- **Web** – HTML, CSS, JavaScript, React for frontend tools

### **Tools & Platforms**
- **Design**: Figma, Photoshop
- **Data Science**: TensorFlow, PyTorch, NumPy, Jupyter
...
## **My Artwork**
Follow my artistic work on Instagram:
